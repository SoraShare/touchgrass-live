...
3. **Multi-Factor Intelligence**: Every trade decision is cross-checked against Kronos 5-day AI time-series predictions, Serenity supply chain bottlenecks, Uzi 65-Investor Panel, and Uzi Trap Detector.
4. **Local & GitHub Automation**: The user can ask you to run rounds locally or rely on GitHub Actions running twice daily (11:30 AM EST & 2:00 PM EST).
